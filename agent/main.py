...
async def _on_prospect_research_complete(result: dict, prospect: dict):
    ...
    try:
        ...
        if strategy == "upward" and school_count:
            ...
            if _is_diocesan:
                # Per-campaign meeting link (Session 59 round 2 feedback — always bake in a fresh calendar link)
                _meeting_link = os.environ.get(
                    "DIOCESAN_CAMPAIGN_MEETING_LINK",
                    "https://hello.codecombat.com/c/steven/t/130",
                )
                extra_context += (
                    ...
                    f"  Use: <a href=\"{_meeting_link}\">grab 15 min here</a> or similar. DO NOT paste the raw URL. HYPERLINK it."
                    ...
                    f"\n\nLINK REQUIREMENTS (Steven's standing rule, memory/feedback_sequence_copy_rules.md):"
                    f"\n- Include <a href=\"https://www.codecombat.com/schools\">codecombat.com/schools</a> HYPERLINKED in at"
                    f"  least 2 of the 5 steps. Natural placements: step 2 (when mentioning turn-key resources) and step 4"
                    f"  (when mentioning efficacy data) work well."
